...
user_input = st.text_input("厚生労働省のモデル就業規則（PDF）を元に回答します。[参照元](https://www.mhlw.go.jp/file/06-Seisakujouhou-11200000-Roudoukijunkyoku/0000118951.pdf)", key="user_input", on_change=communicate)
